...
OutputFolder = 'C:\Users\ME System 3\Documents\projects\OL_DRG_coculture\AFM\2nd_round\2021-03-24\pos1-3\export_curvefitting\';
...
%             [num,txt,raw] = xlsread([folder '\' folderinfo(i).name]);
            [num,txt,raw] = xlsread([folder '\' fname]);
            ...
            [contact,fitvals,Es,Ball,Correlations]=fits5(fdcurve,(count-1)*2,plot_names,OutputFolder);
